:: Run 3 servers
start Server.exe --id server_1 --port 9000 --peers ../peers.txt
...
start Client.exe --id client_5 --host localhost --port 9002 --listener
start Client.exe --id client_6 --host localhost --port 9004 --listener
